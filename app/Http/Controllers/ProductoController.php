...
class ProductoController extends Controller
{
    ...
    public function getShow($id){
        return view('productos.show',array('id'=>$id),array('arrayProductos'=>$this->arrayProductos[$id-1]));
    }
    ...
    public function getEdit($id){
        return view('productos.edit', array('id'=>$id),array('arrayPeliculas'=>$this->arrayProductos[$id]));
    }
}
